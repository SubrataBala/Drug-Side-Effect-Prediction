...
def predict_drug():
    ...
    # 4. Check for interactions between predicted and current medicines
    interactions_found = []
    for current_med_obj in current_medications:
        ...
        if "No specific interaction" not in interaction_desc and "not available" not in interaction_desc:
